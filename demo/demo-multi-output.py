...
if __name__ == '__main__':
    ...
    for token in TOKENS:
        ...
        new_receiver = TxReceiver(payment_wallet.get_address())
        new_receiver.add_native_token(token_id, 1)
        new_receiver.add_lovelace(1650000)
        tx_receiver.remove_lovelace(1650000)
    ...
    raw_matx_path = build_raw_transaction(TEMP_DIR,
                                          input_utxo,
                                          list(map(lambda tx: tx.get_blank_receiver(), receivers)),
                                          policy_id,
                                          minting_receiver,
